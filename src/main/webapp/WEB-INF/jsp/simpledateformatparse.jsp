...
<html lang="en">
    <head>
		<title>Java SimpleDateFormat Parse Tester</title>
	...
	<body>
		<div id="header">
			<h1>Java SimpleDateFormat Parse Tester</h1>
		</div>
		
		<jsp:include page="menu.jsp">
			<jsp:param name="page" value="simpledateformatparse" />
		</jsp:include>
		...
		<div id="content">
			...
			<jsp:include page="parseForm.jsp">
				<jsp:param name="url" value="simpledateformat/parse" />
				<jsp:param name="showTimeZone" value="true" />
			</jsp:include>
